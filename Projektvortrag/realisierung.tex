...
Bei dem Edge-Recombination-Crossover-Verfahren handelt es sich um ein kantenbasiertes Crossover-Verfahren.
Eine Umsetzung ist im Codelisting \ref{lst:erx} zu sehen. Für ein besseres Verständnis wird ein Beispiel in Tabelle \ref{tab:erx2} eingesetzt.
Für das Edge-Recombination-Crossover-Verfahrenn muss in einem ersten Schritt in einer Kanten-Map gespeichert werden, mit welchen Städten jede Stadt, in den Eltern, verbunden ist. Das wird im Code in Zeile 2 durchgeführt und führt im Beispiel zu der Kanten-Map \ref{tab:em}.
