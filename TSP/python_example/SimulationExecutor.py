...
class SimulationExecutor:
    ...
    def __init__(self, label_path: str, distances_path: str, start_city: str, cities: int, population_size: int, generations: int, mutation_rate: int, crossover: int, marriage: int, mutation: int, selection: int):
        ...
        self.result_list: SimulationResultList = SimulationResultList(cities, population_size, generations, mutation_rate, crossover, marriage, mutation, selection)
