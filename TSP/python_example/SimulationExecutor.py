...
class SimulationExecutor:
    ...
    def __init__(self, label_path: str, distances_path: str, start_city: str, cities: int, size_individual: int, generations: int, mutation_rate: int, crossover: int, marriage: int, mutation: int, selection: int):
        self.simulator = Simulator(
            label_path, distances_path, start_city,
            cities, size_individual, generations, mutation_rate,
            crossover, marriage, mutation, selection)
        self.generation: int = 0
        self.result_list: SimulationResultList = SimulationResultList(crossover, marriage, mutation, selection)
