...
parser.add_argument("--mutation_rate", type=int, default=5, help="probability of mutations ocurring in a single generation.")
parser.add_argument("--population_size", type=int, default=10, help="number of individuals within a population.")
parser.add_argument("--marriage_algorithm", type=int, default=2, help=f"use int value [0 = {get_marriage_name(0)}, 1 = {get_marriage_name(1)}, 2 = {get_marriage_name(2)}]")
parser.add_argument("--crossover_algorithm", type=int, default=4, help=f"use int value [0 = {get_crossover_name(0)}, 1 = {get_crossover_name(1)}, 2 = {get_crossover_name(2)}, 3 = {get_crossover_name(3)}, 4 = {get_crossover_name(4)}]")
parser.add_argument("--mutation_algorithm", type=int, default=0, help=f"use int value [0 = {get_mutation_name(0)}]")
parser.add_argument("--selection_algorithm", type=int, default=1, help=f"use int value [0 = {get_selection_name(0)}, 1 = {get_selection_name(1)}]")
...
Plotter.plot_roundtrip(Position.convert_idxs_to_positions(executor.best_individual(), city_positions), Position.convert_idxs_to_positions(best_roundtrip[1], city_positions))
